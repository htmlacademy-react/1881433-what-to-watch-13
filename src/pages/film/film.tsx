...
import { TFullFilmInfo } from '../../types/film-type.ts';
import Header from '../../components/header.tsx';

function Film(): JSX.Element {
  const films = useAppSelector((state) => state.films);
  const { filmId } = useParams();
  const fullFilmDescription = films.find(({ id }) => id === filmId) as unknown as TFullFilmInfo;
  if (!fullFilmDescription) {
    return (
  ...
  /*const {
    ...
    genre,
    released,
    isFavorite, } = fullFilmDescription;*/
  return (
    <>
